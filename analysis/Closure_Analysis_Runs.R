...
closure <- init_closure(input_coords = NULL, basis = sc$data_type[r], rationale = sc$basis[r], spp1 = 'spp1', spp2 = 'spp2', year_start = 5, year_basis = c(1:4), closure_thresh = 0.9, sc = sc$resolution[r], temp_dyn = sc$timescale[r])
