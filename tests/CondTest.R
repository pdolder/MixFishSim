...
closure <- init_closure(input_coords = NULL, basis = 'commercial', rationale = 'high_ratio', spp1 = 'spp1', spp2 = 'spp2', year_start = 2, year_basis = 1, closure_thresh = 0.9, sc = 5, temp_dyn = 'annual')
