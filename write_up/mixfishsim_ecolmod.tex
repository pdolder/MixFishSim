...
\begin{equation}
C_{c,d} = \frac{F_{c,d}}{F_{c,d} + M_{c,d}} * (1 - \mathrm{e}^{-(F_{c,d} + M_{c,d})})
\cdot B_{c,d}
\end{equation}
...
\begin{equation}
	Pr(J | I) = \frac{\mathrm{e}^{-\lambda * d_{IJ}} \cdot
		(Hab_{J,p}^2 \cdot
...
demographics; growth rates, natural mortality and recruitment parameters (Table
