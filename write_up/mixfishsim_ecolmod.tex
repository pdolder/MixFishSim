...
In total 56 closure scenarios were run which represent combinations of: three
data types; commercial logbook data, survey data and 'real population', three
temporal resolutions; weekly, monthly and yearly closures, and four spatial
resolutions; 1 x 1 grid, 5 x 5 grid, 10 x 10 grid and 20 x 20 grid. Survey
closures were on an annual basis, as the most temporally resolved survey data
available.
