...
targeting - that determines\replaced[id=PD]{d}{s} the fleet catch efficiency
and preference towards a particular species; trip-level decisions, that 
determines\added[id=PD]{d} the initial location to be fished at the beginning of
...
and therefore discarding of species for which vessels have no quota or that 
