...
basis\footnote{\added[id=JJ]{Its not clear what the problem is: landed
...
landings data assigned to VMS activity pings\footnote{\added[id=JJ]{This comes as a
...
population, and effect on the other three populations\footnote{\added[id=JJ]{If
...
the daily biomass for the population in the cell. \textcolor{red}{[link $F$ to
