...
%avoided, but if essential, then citep the author(s) and year(s). Also,
...
species, known as mixed fisheries \replaced[id=JJ]{may}{, when managed by
	single-species quotas can end up} discard\deleted[id=JJ]{ing} overquota
catch \added[id=JJ]{when managed by single species quotas,} leading to
overexploitation of fish populations \added[id=JJ]{\citep{Ulrich2011a,
	...
	within sustainable limits \citep{Alverson1994, Crowder1998,
		Rijnsdorp2007}.} Reducing discarding is crucial to ensure
biological and economic sustainability of fisheries\deleted[id=JJ]{ and
	implementation of an ecosystem approach to
	fisheries}\replaced[id=PD]{and}{. As such} there is increasing interest
in technical solutions such as gear and spatial closures as ways of avoiding
discard\replaced[id=JJ]{ing of fish \citep{Kennelly2002, Catchpole2008,
		Bellido2011}}{s}.  \\

Use of spatial management as a tool has been proposed as a method to reduce
discards \added[id=PD]{\citep{Holmes2011, Little2014, Dunn2014a}}. However, its
...
basis\todo{\added[id=JJ]{Its not clear what the problem is: landings
		collected on daily basis or landings recorded rather than catch}}.
This leads to questions about the validity of inference that can be drawn from
landings data assigned to VMS activity pings\todo{\added[id=JJ]{This comes as a
	surprise: I thought this was going to be about discards}}.\\ 
...
population, and effect on the other three populations\todo{\added[id=JJ]{If
		the paper has two goals this should be clear from the start,
		but may be better over 2 MSs}}. Further, we extend our analysis
...
%previously published method, use quotation marks and also citep the source. Any
...
individual to a species\deleted[id=PD]{.}\added[id=PD]{, while the fishing
	module operates on a tow-by-tow basis (multiple events a day)}. The
