...
To illustrate the capabilities on \emph{MixFishSim}, we investigate the influence of ... \textcolor{red}{[expand]}. To do so, we first set up with simulation to run for 20 years based on a 100 X 100 square grid,
...
fishing location yields in the top X \textcolor{red}{[??]}quartile of the value available in that
...
\begin{itemize}
	...
	\item Some measure of temporal trends/changes in spatial composition -
		...
		changing habitat suitability covariate, e.g. temperature ?? \textcolor{red}{[temperature would be very interesting and cover varying spatial fields]}
