...
data source and aggregation level (Figure \ref{fig:1}; visualised using
\cite{Gerritsen2014}). The finer spatial grid for the true population (top
left) and commercial data (top middle) show visually similar patterns, though
there are large unsampled areas in the commercial data from a lack of fishing
...
there remains good consistency between the true population and the commercial
