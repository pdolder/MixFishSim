...
\added{\replaced{MixFishSim}{Our framework} allows users to explore the assumptions in modelling
	...
	approaches at a fine spatial and temporal scale. }\added{From our
...
hotspots and indeed behind spatiotemporal modelling in general\replaced{,}{ (}e.g. comparing
GAMs, GLMMs, Random Forests and geostatistical models under different data
generation processes as exampled by \cite{Stock2019}\deleted{)}. \\
...
\begin{figure}[!ht]
	...
	\caption{[Colour] Data aggregation at different spatial resolutions
		over a ten year period. \added{The figure shows catch
			...
			each colour is proportionate to the weight of each
