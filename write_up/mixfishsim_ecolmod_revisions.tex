...
\added{which are affected by the suitability of habitat, temperature in a cell
...
determines the smoothness of the process. \added{We use the most commonly used
	Matérn covariance structure as it is a flexible form that under certain
	conditions is of the same form as an exponential function and
...
locations, \added{but that correlation decreases non-linearly}
