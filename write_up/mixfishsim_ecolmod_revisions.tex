...
The \deleted{aggregated }catch composition\added{aggregated at different
...
true population, though the population 1 \deleted{(in red)} is less well
...
\ref{tab:7}). \deleted{Again, y}\added{Y}early values head a similar mean but
