...
closures, following which the fisheries ``adapted" to the closures \added{by
	finding new areas of high abundance to fish which led to} fishing
mortality increasing again, though not to past levels. The exception to the
...
\begin{figure}[!ht]
	...
	\caption{Fishing mortality dynamics - the daily fishing mortalities
		...
		patterns in exploitation.  Individual years a\replaced{re}{nd}
		the light grey lines, the mean of all years the thick black
		line.}
	\label{fig:10}
\end{figure}	
...
\begin{figure}[!ht]
	...
	\caption{The location of fishing effort before the spatial closure (a)
		and after the spatial closure (b), and the suitable habitat for
		population 3 (c). The site of the closure can be seen in the
		red box on all three panels.}
	\label{fig:17}
\end{figure}	
